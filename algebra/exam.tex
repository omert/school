...
%    polynomial of $a$. 
  \item
    We would like to factor $x^{27}-x$. The roots of this polynomial, over
    $GF(27)$, are precisely the elements of $GF(27)$: 0 is clearly a root,
    ...
    roots, then we've demonstrated that the elements of $GF(27)$ 
    are the set of roots of $x^{27}-x$.
