...
%    polynomial of $a$. 
  ...
  \item
    ...
    \item Be two disjoint cycles of size two, e.g. $(12)(34)$. The number of 
      ...
      for the lowest number). These elements are of order two.
    ...
    for. We note that two elements of different orders (both larger than one)
    cannot commute, as they have cycles of different sizes which cannot all
    be disjoint.
    ...
    \item {\bf 12}
      ...
      an element of order three that commutes with an element of order two,
      which is impossible.
