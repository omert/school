...
\begin{enumerate}
  ...
  \item
    ...
    If, in addition, the number of times that each index key was visited 
    were to be kept in the table, and finally all the counts of all the valid 
    terminal sets (the ones with no dangling edges, signifying a solution) 
    are summed, then that sum will be the number of solutions, at no additional
