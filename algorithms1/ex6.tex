...
\item 
  ...
  \item 
    ...
    A graph with largest eigenvalue $\lambda_1$ has maximal degree at most
    $\lfloor \lambda_1 \rfloor +1$, and hence, using inductive coloring,
    can be colored with $\lfloor \lambda_1 \rfloor +1$ colors.

  \item 
    
    Let $G$ be a $d$-regular graph. $G$ can clearly not be colored with 
    less than $d+1$ colors. Since $\lambda_1=d$ then it cannot be
...
\item
  ...
  and $x$ and $y$ are orthogonal. Hence
  \begin{eqnarray*}
    x^ty&=&0
