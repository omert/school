...
and $\vecy'$. If $\myvec{z}$ is the point of intersection of these lines
then we would like to calculate the area $f$ of the triangle $\vecx$
$\vecy$ $\myvec{z}$ (Fig.~\ref{fig:triangle_area_example}).
...
Since the vector from $\vecx$ to $\myvec{z}$ has direction $\vecx'$
and the vector from $\vecy$ to $\myvec{z}$ has direction $\vecy'$ then
\begin{equation}
  \myvec{z}=\vecx+\alpha \vecx'=\vecy+\beta \vecy'
\end{equation}
or
\begin{equation}
  \label{eq:triangle_area_example1}
  \myvec{z}-\vecx=\alpha \vecx'=(\vecy-\vecx)+\beta \vecy'.
\end{equation}
we can therefore claim that for the area we are interested in, it holds that 
\begin{equation}
  \label{eq:triangle_area_example2}
  f={1\over 2}(\myvec{z}-\vecx,\vecy-\vecx)
...
\begin{figure}[htp]
  \centering
  \includegraphics{affine_length.pdf}
  \caption{}
...
\begin{figure}[htp]
  \centering
  \includegraphics{segment_sequence.pdf}
  \caption{}
